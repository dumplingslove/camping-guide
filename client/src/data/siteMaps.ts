...
export const siteMaps: Record<number, SiteMapInfo> = {
  ...
  12: { kind: "static", url: `${base}maps/sites/camp-12.jpg`, thumb: `${base}maps/sites/thumbs/camp-12.jpg`, source: "KOA 官方", sourceUrl: "https://koa.com/campgrounds/astoria/map/" },
  ...
  23: { kind: "static", url: `${base}maps/sites/camp-23.jpg`, thumb: `${base}maps/sites/thumbs/camp-23.jpg`, source: "National Park Service", sourceUrl: "https://www.nps.gov/crla/planyourvisit/mazama_campground.htm" },
  26: { kind: "static", url: `${base}maps/sites/camp-26.pdf`, thumb: `${base}maps/sites/thumbs/camp-26.jpg`, source: "Washington State Parks", sourceUrl: "https://parks.wa.gov/sites/default/files/2023-05/Grayland%20Beach%20full%20color%20map.pdf" },
  37: { kind: "static", url: `${base}maps/sites/camp-37.pdf`, thumb: `${base}maps/sites/thumbs/camp-37.jpg`, source: "Sol Duc 温泉度假村官方（NPS 特许运营方）", sourceUrl: "https://www.olympicnationalparks.com/lodging/sol-duc-hot-springs-resort/" },
  ...
  55: { kind: "static", url: `${base}maps/sites/camp-55.pdf`, thumb: `${base}maps/sites/thumbs/camp-55.jpg`, source: "US Forest Service", sourceUrl: "https://www.fs.usda.gov/r06/mbs/recreation/middle-fork-campground" },
