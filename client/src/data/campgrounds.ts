...
export const campgrounds: Campground[] = [
    ...
    tcNotes: "营位在树林中，部分较窄。适合小型到中型TC。无Hookup。",  },
  {
    ...
    kidRating: 4,
    tcRating: 3,
    warning: "2026年9月15日至2027年6月15日期间，因全园更换水管，露营区将关闭。另外，营地紧邻铁路，日夜有火车经过，噪音较大，建议携带耳塞。",
    tier: "明显热门",
    ...
    tcNotes: "宽敞的RV营位，有Full Hookup。Loop较平坦，进出方便。",  },
  {
    ...
    driveTimeLabel: "4.3h",
    tagline: "历史与自然的完美结合",
    image: "/manus-storage/champoeg_d778aa8b.png",
    bookingSystem: "Oregon State Parks (ReserveAmerica)",
